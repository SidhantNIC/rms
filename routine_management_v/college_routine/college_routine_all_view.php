    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"> <a href="<?php echo base_url('admin/routine_management_c/college_routine/College_routine_list'); ?>"
                        class="btn btn-primary btn-xs activate">Back</a><!-- Employee Profile -->
                </h3>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover custom_table">
					...
					<tr>
						<td nowrap style="font-weight: bold; width: 25%;">Section</td>
						<td nowrap style="font-weight: bold; width: 25%;"><?php echo $routine[0]['section_name']; ?></td>
					</tr>
                    <tr>
