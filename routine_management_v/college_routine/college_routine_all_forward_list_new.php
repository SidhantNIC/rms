...
<div class="content-wrapper">
   ...
   <!-- Main content -->
   <?php echo form_open('admin/routine_management_c/college_routine/College_routine_list/forwardList_new'); ?>
   <div class="row" style="padding: 5px;">
      ...
      <div class="col-sm-4">
         ...
         <select class="form-control" name="routine_mode" id="routine_mode">
            ...
            <option value="1" <?php echo set_select('routine_mode', 1, False); ?>>Created</option>
            <option value="2" <?php echo set_select('routine_mode', 2, False); ?>>Forwarded</option>
            <option value="4" <?php echo set_select('routine_mode', 4, False); ?>>Approved</option>
      ...
      <div class="col-sm-2">
         <button type="submit" class="btn btn-primary btn-block" style="margin-top:25px;"> <i class="fa fa-search"></i><b> Search</b></button>
      </div>
   </div>
   ...
   <?php if (count($countresult) > 0) { ?>
      ...
      <center>
         <?php if ($countresult > 0 && $forwardlist['routine_mode'] == '2') {  ?>
            <?php echo form_open('admin/routine_management_c/college_routine/College_routine_list/approveRoutine'); ?>
            <?php
            ...
            <?php } ?>
            <button class="btn btn-warning btn-xs" type="submit" style="margin-right:15px;"><i class="fa fa-check-square"></i> <b>Approve Routines</b></button>
            <?php echo form_close(); ?>
         <?php } else { ?>
            <?php echo form_open('admin/routine_management_c/college_routine/College_routine_list/downloadRoutineCollege_new'); ?>
            ...
            <center><button class="btn btn-info btn-xs" type="submit"><i class="fa fa-download"></i> <b>Download Routine</b></button></center>
            <?php echo form_close(); ?>
         <?php } ?>
      </center>
   <?php } else { ?>
