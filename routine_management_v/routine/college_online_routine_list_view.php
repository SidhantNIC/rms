...
<div class="content-wrapper">
    ...
    <?php echo form_open('admin/routine_management_c/routine/College_online_routine'); ?>
    ...
    <?php echo form_open('admin/routine_management_c/routine/College_online_routine/assignRoutineonline'); ?>

    <!-- <button class="btn btn-success" onclick="return confirm('Do you want to Assign  the Routines For Online?');" style="position: relative;left: 10px;">Mark Online All</button> -->
            ...
            <tbody>
                ...
                foreach ($all_emp_list as $all_emp_list) { ?>
                    <tr align="center">
                        ...
                        <td><span class="text-danger"><?php echo $all_emp_list['routine_online_status'] == '1' ? "<b>Online & Offline</b>" : "<b>Offline</b>" ?></span>
                        </td>
                        <td>
                            <?php if ($all_emp_list['routine_online_status'] != '1') { ?>
                                <a href="<?php echo base_url('admin/routine_management_c/routine/College_online_routine/assignRourineusingid') ?>/<?php echo md5($all_emp_list['routine_manage_id_pk']); ?>"><button class="btn btn-warning btn-xs" type="button" onclick="return confirm('Do you want to assign this routine for Online?');"><i class="fa fa-check" aria-hidden="true"></i> Mark
                                        Online</button></a>
                            <?php } else { ?>
                                <button class="btn btn-warning btn-xs" type="button" disabled> <i class="fa fa-check" aria-hidden="true"></i> Mark
                                    Online</button>
                            <?php } ?>
                            <?php if ($all_emp_list['online_routine_status_current'] == '9') { ?>
                                <a href="<?php echo base_url('admin/routine_management_c/routine/College_online_routine/forwardOnlineroutine') ?>/<?php echo md5($all_emp_list['routine_manage_id_pk']); ?>"><button class="btn btn-info btn-xs" type="button" onclick="return confirm('Do you want to forward this routine to principal?');"><i class="fa fa-share" aria-hidden="true"></i> Forward</button></a>
                            <?php } ?>
