...
<div class="content-wrapper">
   ...
   <?php } ?>
   <!-- Main content -->
   <?php echo form_open('admin/routine_management_c/routine/Routine_add/routineForwardlist'); ?>
   ...
   <div class="tablebody">
      ...
      <center>
         ...
         <button type="submit" class="btn btn-warning" onclick="return confirm('Once you forward all routines,For Check routine you have downlaod the routine.');">Forward</button>
    
         
     
         <a
            href="<?php echo base_url('admin/routine_management_c/routine/Routine_add/downlaodRoutinepdf')?>/<?php echo (@$forwardlist['academic_year']);?>/<?php echo (@$forwardlist['discipline_type']);?>/<?php echo (@$forwardlist['stud_year']);?>/<?php echo (@$forwardlist['semester']);?>"><button
