    ...
    <section class="content">   
      <div class="box box-primary">
        <div class="box-header with-border">
              <h3 class="box-title"> <a href="<?php echo base_url('admin/routine_management_c/routine/Routine_add/routine_list'); ?>" class="btn btn-primary btn-xs activate">Back</a><!-- Employee Profile --></h3>
                    ...
                    <tr>
                     ...
                     <?php } ?>
					  ...
					  <tr>
						  ...
						  <td colspan="3"><?php echo $routine[0]['section_name']; ?></td>
                      </tr>
					  <?php } ?>
					  <tr>
