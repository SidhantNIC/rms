...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Routine Update</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box box-primary">
            ...
            <?php echo form_open('admin/routine_management_c/routine/Routine_add/editRoutine/'.$routine_id); ?>
            <!--...........Form Start...........-->
            ...
            <div class="row" style="padding: 5px;">
                ...
                <div class="col-sm-3">
                    ...
                    <?php if($all_details[0]['status_code'] == '3'){ ?>
                    ...
                    <?php if ($all_details[0]['status_code'] == '3') { ?>
                        <select class="form-control" readonly>
                            ...
                            <?php foreach ($section_data as $sd) { ?>
                                <option value="<?php echo $sd['section_id_pk'] ?>" <?php echo ($all_details[0]['section_id_fk'] == $sd['section_id_pk']) ? 'selected' : '' ?> disabled>
                                    <?php echo $sd['section_name'] ?>
                                </option>
                            <?php } ?>
                            <input type="hidden" name="section_name" value="<?php echo $all_details[0]['section_id_fk']; ?>" id="section_name">
                        </select>
                    <?php } else { ?>
                        <select class="form-control" name="section_name" id="section_name">
                            <option value="">--Please Select Section --</option>
                            <?php foreach ($section_data as $sd) { ?>
                                <option value="<?php echo $sd['section_id_pk'] ?>" <?php echo ($all_details[0]['section_id_fk'] == $sd['section_id_pk']) ? 'selected' : '' ?>>
                                    <?php echo $sd['section_name'] ?>
                                </option>
                            <?php } ?>
                        </select>
            ...
            <div class="row" style="padding: 5px;">
                ...
                <div class="col-sm-4 tutorial" style="display: none;">
                    ...
                    <select class="form-control" name="tutoraial_subj_name" id="tutoraial_subj_name">
                        <option value="">--Please Select Subject --</option>
                        <?php foreach($totiroal_subjects as $subject){ ?>
                        <option value="<?php echo $subject['subject_code']?>"
                            <?php echo ($all_details[0]['subject_id_fk']==$subject['subject_code'])?'selected':'' ?>>
                            <?php echo $subject['subject_description']?>
                        </option>
			...
			<?php if($all_details[0]['period_type_id']==1 || $all_details[0]['period_type_id']==5) {?>
			
				<div class="row" id="theroytech" style="padding: 5px;">
					<div class="col-sm-4">
			...
			<?php }elseif($all_details[0]['period_type_id']==2){?>
