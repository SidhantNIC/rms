            ...
            <table id="example1" class="table table-bordered table-hover custom_table">
				...
				?>
                    ...
                    <tr>
						...
						<td>
							<?php 
							if($emp_details_view['section_id_fk']=='1'){
								echo"Section A";
							}elseif($emp_details_view['section_id_fk']=='2'){
								echo"Section B";
							}else{
								echo"No Section";
							}
								//echo $emp_details_view['section_id_fk']; 
							?>
						</td>
						<td><button class="btn btn-primary" type="button" disabled><?php echo ($emp_details_view['process_description']);  ?></button></td>
                        ...
                        <td>
                            ...
                            <button class="btn btn-success"
                                onclick="showExecution(<?php echo $emp_details_view['routine_manage_id_pk'] ?>,<?php echo $emp_details_view['period_no'] ?> );">Class
                                Execution</button>
                            <?php } ?>-->
        ...
        <div class="modal-content">
            ...
            <span class="text-danger" align="justify">Note:If the classes has been taken on otherthan scheduled date and time that should be mention in reason</span>
                ...
                <div class="col-sm-12 textar">
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Remarks By Faculty</label>
                ...
                <div class="col-sm-12 class_execution_reason" style="display: none;">
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">If Class Not Executed (Reason)</label> <span
